...
final courseInstructions = [
  ...
  'Note: the class should be the class code which matches a class code in the classes sheet. eg. (200B-200E).\n Eg. Dr. Joshua Dagadu(100A-100D),Mr. Oliver Buansi(100E-100I),etc.'
];
